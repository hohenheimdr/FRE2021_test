...
private:
	...
	int HEADLAND_TURN= 3;
	int STATIC= 4;
	int pattern=1;//start pattern =1 for first turn left, 2 for first turn right
					...
					ROS_INFO("row_navigation");
						 ...
						 if(headland_detected)
						{
							...
							switch (pattern)
							{
								case 1:
									ROS_INFO("start 2R ");
									system("roslaunch fieldrobot_event2017 start_pattern_2R.launch");
								break;
								case 2:
									ROS_INFO("start 1L ");
								...
								case 3:
									ROS_INFO("start 4R ");
									system("roslaunch fieldrobot_event2017 start_pattern_4R.launch");
								break;
								case 4:
									ROS_INFO("start 3R ");
									system("roslaunch fieldrobot_event2017 start_pattern_3R.launch");
								break;
								case 5:
									ROS_INFO("start 4R ");
									system("roslaunch fieldrobot_event2017start_pattern_4R.launch");
								break;
								default:
								break;
							}
